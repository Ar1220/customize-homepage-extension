...
export function Sidebar({ themeColor = "#c58bf2", onSearchClick, onWidgetsClick, bookmarks = [], searchIconUrl }: SidebarProps) {
  ...
  return (
    <motion.div 
      ...
      className="flex flex-col items-center py-6 px-3 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 pointer-events-auto"
      style={{ 
