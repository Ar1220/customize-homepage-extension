...
export function EtherealClock({ 
  ...
  return (
    <div
      ...
      style={transparentBg ? {
        ...(bgBlurEnabled ? { backdropFilter: `blur(${bgBlur}px)`, WebkitBackdropFilter: `blur(${bgBlur}px)` } : {}),
      } : {
        background: 'linear-gradient(135deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.005) 100%)',
        backdropFilter: bgBlurEnabled ? `blur(${bgBlur}px)` : 'blur(12px)',
        WebkitBackdropFilter: bgBlurEnabled ? `blur(${bgBlur}px)` : 'blur(12px)',
    ...
    >
      ...
      {!transparentBg && (
        <div className="absolute inset-0 rounded-[3rem] pointer-events-none z-0" style={{
          background: `radial-gradient(150% 150% at 30% 0%, rgba(255,255,255,0.08) 0%, transparent 100%), rgba(0,0,0,${bgOpacity / 100})`
        }} />
      )}
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex items-baseline gap-3 leading-none mb-1">
            <span 
              ...
              style={{ color: textColor, textShadow: `0 8px 30px rgba(0,0,0,0.5), 0 0 20px ${color}30` }}
            >
              {minutes}
            </span>
          ...
          <div className="flex items-center gap-3 text-xs font-space tracking-[0.2em] text-white/70 uppercase ml-1">
            <span 
              ...
              style={strokeEnabled ? {
                ...
                textShadow: `0 0 4px ${strokeColor}40`
              } : { 
