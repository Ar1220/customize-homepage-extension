                          ...
                          onChange={async (e) => {
                            ...
                            if (file) {
                              if (removeBgEnabled) {
                                ...
                                try {
                                  const imglyConfig = {
                                    publicPath: "https://cdn.jsdelivr.net/gh/Ar1220/customize-homepage-extension@main/browser_exten/Ui/dist/imgly/data/",
                                    debug: false,
                                    model: "medium"
                                  };
                                  ...
                                  if (!navigator.onLine) {
                                    console.error("Offline Error: Failed to fetch IMG.LY models during initialization because the user is completely offline.", error);
                                  } else {
